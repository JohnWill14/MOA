...
import br.com.uem.mochila.Instance;
import br.com.uem.mochila.Mochila;
import br.com.uem.mochila.MochilaComMelhoramento;
...
public class Main {
    ...
    private static void mochilaOtimizada(Instance instance){
        Mochila mochila = new MochilaComMelhoramento(instance);
